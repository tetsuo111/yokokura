...
<html:form action="/mail/entrycomplete" name="GlobalDummyForm" type="org.apache.struts.action.DynaActionForm">
<tr>
<td class="text12">
  <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#82a589">
    ...
    <tr>
      <td bgcolor="#eff5f0" align="center"><br>
          <table align=center cellpadding=5 cellspacing=5  class="text12" border="0" width="510">
            ...
            <tr>
              <td width=120 height="20">氏名</td>
              <td width="354">姓：
                  <bean:write name="user_mail_form_EntryForm" property="lastName" ignore="true" filter="true" />
            　名：
            <bean:write name="user_mail_form_EntryForm" property="firstName" ignore="true" filter="true" />
              </td>
            </tr>
            <tr>
              <td width="120" height="20">電子メール</td>
              <td><bean:write name="user_mail_form_EntryForm" property="mailaddress" ignore="true" filter="true" />
              </td>
            </tr>
          </table>
          <br>
    ...
    <tr height="40">
      <td align="center" bgcolor="#d1e3dc" height="40"><html:submit property="submit3" value="登録"/></td>
    </tr>
    <tr height="40">
      <td align="center" bgcolor="#d1e3dc" height="40"><html:link page="/mail/entryconfirmback.do">戻る</html:link></td>
	</tr>
  </table>
</td>
</tr>
