...
<html:form action="/mail/deletecomplete" name="GlobalDummyForm" type="org.apache.struts.action.DynaActionForm">
<tr>
<td class="text12">
  <table width="100%" border="0" cellspacing="1" cellpadding="2" bgcolor="#82a589">
      ...
      <td bgcolor="#eff5f0" align="center"><br>
          <table align=center cellpadding=5 cellspacing=5  class="text12" border="0" width="510">
            <tr>
              ...
              <td width="354">
				<bean:write name="user_mail_form_EntryForm" property="releaseMailaddress" ignore="true" filter="true" />
              </td>
            </tr>
          </table>
          <br>
    ...
    <tr height="40">
      <td align="center" bgcolor="#d1e3dc" height="40"><html:submit property="submit3" value="解除"/></td>
    </tr>
    <tr height="40">
